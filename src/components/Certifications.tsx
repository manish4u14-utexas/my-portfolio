    ...
    >
      <div className={`relative w-full h-full transition-transform duration-500 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
        ...
        <div className="absolute w-full h-full backface-hidden bg-gray-100 rounded-lg shadow-lg p-6 flex flex-col">
          ...
          <div className={`absolute inset-0 bg-white bg-opacity-70 flex items-center justify-center rounded-lg transition-opacity duration-300 ${isHovered && !isFlipped ? 'opacity-100' : 'opacity-0'}`}>
            <p className="text-gray-500 text-sm font-medium">Click to see the certificate</p>
          </div>
        </div>
        ...
        <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-white rounded-lg shadow-lg p-4 flex flex-col items-center justify-center">
          ...
          {verificationLink && (
            <div className={`absolute inset-0 bg-white bg-opacity-70 flex items-center justify-center rounded-lg transition-opacity duration-300 ${isHovered && isFlipped ? 'opacity-100' : 'opacity-0'}`}>
              <p className="text-gray-500 text-sm font-medium">Click to validate the certificate</p>
            </div>
          )}
        </div>
      </div>
