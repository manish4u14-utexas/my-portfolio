  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h2 
          className={`text-4xl font-bold text-center mb-12 text-sky-400 transition-all duration-700 ease-out ${sectionInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          About Me
        </h2>
        ...
        <div 
          className={`mt-12 pt-8 border-t border-slate-600 transition-all duration-700 ease-out ${listInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <h3 className="text-2xl font-semibold mb-6 text-sky-400 flex items-center">
            <span className="mr-2">🚀</span>Signature AI Impacts
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-gray-300 pl-4 md:pl-6">
            <div className="space-y-6">
              <div className="bg-slate-700 p-5 rounded-lg border-l-4 border-sky-500">
                <h4 className="font-bold text-sky-400 mb-3 text-base">Enterprise AI Documentation Architect</h4>
              ...
              <div className="bg-slate-700 p-5 rounded-lg border-l-4 border-sky-500">
                <h4 className="font-bold text-sky-400 mb-3 text-base">AI-Driven Reporting & Compliance</h4>
                <p className="text-sm mb-2">
            ...
            <div className="space-y-6">
              <div className="bg-slate-700 p-5 rounded-lg border-l-4 border-sky-500">
                <h4 className="font-bold text-sky-400 mb-3 text-base">Intelligent Support Automation Lead</h4>
                <p className="text-sm mb-2">
              ...
              <div className="bg-slate-700 p-5 rounded-lg border-l-4 border-sky-500">
                <h4 className="font-bold text-sky-400 mb-3 text-base">Deep Learning Research (NLP)</h4>
                <p className="text-sm mb-2">
        ...
        <div 
          ...
          className={`mt-12 pt-8 border-t border-slate-600 transition-all duration-700 ease-out ${listInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <h3 className="text-2xl font-semibold mb-8 text-sky-400 flex items-center">
            <span className="mr-2">⚡</span>Technical Competencies & Expertise
          </h3>
          
          {/* Core AI Competencies */}
          <div className="mb-8">
            <h4 className="text-lg font-semibold text-sky-400 mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 pl-4 md:pl-6">
              {[
                ...
                <div 
                  key={index}
                  className={`bg-slate-700 p-3 rounded-lg border-l-3 border-sky-500 text-sm font-medium text-gray-200 transition-all duration-500 ease-out hover:shadow-md ${listInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pl-4 md:pl-6">
              <div className="space-y-4">
                <div className="bg-slate-700 p-4 rounded-lg border border-slate-600 shadow-sm">
                  <h5 className="font-semibold text-sky-400 mb-3 flex items-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Azure OpenAI", "GPT-4/3.5", "Agentic AI", "LSTM", "NLP", "TF-IDF"].map((tech, i) => (
                      <span key={i} className="px-2 py-1 bg-sky-900 text-sky-300 text-xs rounded-full font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-slate-700 p-4 rounded-lg border border-slate-600 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Python", "Flask", "Pandas", "NumPy", "Scikit-learn", "Bash", "SQL"].map((tech, i) => (
                      <span key={i} className="px-2 py-1 bg-green-900 text-green-300 text-xs rounded-full font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-slate-700 p-4 rounded-lg border border-slate-600 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Power Automate", "Power Apps", "AI Builder", "Dataverse", "SharePoint"].map((tech, i) => (
                      <span key={i} className="px-2 py-1 bg-purple-900 text-purple-300 text-xs rounded-full font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-slate-700 p-4 rounded-lg border border-slate-600 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["New Relic", "Splunk", "Kibana", "JIRA", "Atlassian AI"].map((tech, i) => (
                      <span key={i} className="px-2 py-1 bg-orange-900 text-orange-300 text-xs rounded-full font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
