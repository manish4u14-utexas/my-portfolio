...
const About: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      ref={sectionRef}
      className="py-20 px-4 md:px-10 bg-slate-700 text-gray-200 overflow-hidden" // Added overflow-hidden for animations
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h3 className="text-2xl font-semibold mb-6 text-sky-300">Key Areas of Expertise:</h3>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-gray-300">
            {[
              ...
              >
                <span className="text-sky-500 mr-3 text-xl">✔</span>{item}
              </li>
            ))}
          </ul>
        </div>
