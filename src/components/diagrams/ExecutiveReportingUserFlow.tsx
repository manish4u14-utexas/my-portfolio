...
const ExecutiveReportingUserFlow: React.FC = () => {
  ...
  return (
    <div ref={ref} className="w-full h-full p-3 sm:p-4 flex flex-col justify-between overflow-hidden">
      ...
      {/* Steps - 2 rows on mobile (3+2), 1 row on desktop */}
      <div className="mb-3">
      ...
      {/* Flow arrow */}
      <div className={`flex items-center justify-center gap-2 my-2 transition-all duration-500 ${step >= 6 ? 'opacity-100' : 'opacity-0'}`}>
