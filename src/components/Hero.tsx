  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-4xl mx-auto">
        ...
        <p 
          className={`text-md md:text-lg italic text-gray-800 mb-6 transition-all duration-1000 ease-out delay-300 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
